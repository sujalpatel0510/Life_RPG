...
export const LevelUpCelebration: React.FC<LevelUpCelebrationProps> = ({ newLevel, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-modal-backdrop">
      <div className="relative max-w-md w-full surface border-2 border-indigo-500 rounded-2xl p-6 sm:p-8 text-center shadow-[0_0_50px_rgba(99,102,241,0.35)] animate-modal-card">
        ...
        <div className="mt-8 space-y-4">
          <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/10 border border-indigo-300 dark:border-indigo-500/30 text-indigo-900 dark:text-indigo-300 text-xs font-semibold uppercase tracking-wider">
          ...
          <div className="py-4 px-6 bg-indigo-50 dark:bg-slate-800/80 rounded-xl border border-indigo-300 dark:border-indigo-500/30 inline-block shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3 text-left pt-2">
            <div className="surface-panel border border-slate-200 dark:border-slate-700 rounded-lg p-3 shadow-sm">
              <span className="text-[11px] text-body block font-medium">All Attributes</span>
            ...
            <div className="surface-panel border border-slate-200 dark:border-slate-700 rounded-lg p-3 shadow-sm">
              <span className="text-[11px] text-body block font-medium">Boss Strike</span>
          ...
          <button
            ...
            className="btn-tactile w-full py-3.5 mt-4 rounded-xl btn-primary text-white font-fantasy font-bold text-base shadow-lg shadow-indigo-600/30 transition transform hover:-translate-y-0.5 active:translate-y-0"
          >
            CLAIM YOUR GLORY
          </button>
        </div>
