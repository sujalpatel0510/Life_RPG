...
export const AuthPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-100 via-white to-rose-50/50 dark:from-[#060810] dark:via-[#0b0f1d] dark:to-[#04060c] relative">
      ...
      <div className="relative w-full max-w-xl bg-white dark:bg-[#0f1526]/90 border border-slate-200 dark:border-slate-700/80 rounded-3xl p-6 sm:p-10 shadow-2xl backdrop-blur-xl text-slate-900 dark:text-slate-100">
        ...
        <div className="text-center space-y-2 mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-rose-600 to-red-800 border border-rose-400/50 shadow-lg shadow-rose-600/25 mb-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  return (
                    <button
                      ...
                      className={`btn-tactile p-3 rounded-xl border text-left transition ${
                        isSelected
                          ? 'border-rose-500 bg-rose-50 dark:bg-rose-500/10 shadow-sm ring-1 ring-rose-400/40'
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center space-x-1.5 font-bold text-xs text-slate-900 dark:text-slate-200">
                          <Icon className="w-3.5 h-3.5 text-rose-600 dark:text-rose-400" />
                          <span>{c.name}</span>
                        </div>
                        {isSelected && <Check className="w-3.5 h-3.5 text-rose-600 dark:text-rose-400 stroke-[3]" />}
                      </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 text-sm focus:outline-none focus:border-rose-500 transition shadow-sm"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-tactile w-full py-3.5 mt-2 rounded-xl bg-gradient-to-r from-rose-600 to-red-600 hover:from-rose-500 hover:to-red-500 text-white font-fantasy font-black text-sm tracking-wider shadow-lg shadow-rose-600/25 transition transform hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 flex items-center justify-center space-x-2"
          >
        ...
        <div className="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800/80 text-center">
          ...
          <button
            ...
            className="text-xs text-rose-700 dark:text-rose-400 hover:text-rose-900 dark:hover:text-rose-300 underline font-semibold transition"
          >
